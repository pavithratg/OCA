...
class SuperClass {
	...
	/*
	 * As per Section 12.4.1 given here:
	 ...
	 * the class or interface that actually declares it, even though it might be
	 * referred to through the name of a subclass, a subinterface, or a class
